...
main:
 | EOF { Printf.printf "\nbye"; exit 0 }
 | LET IDENT EQUAL expr END_OF_EXPRESSION { Ml_definition($2, fst $4), StrSet.remove $2 (snd $4) }
 | LET REC IDENT EQUAL expr END_OF_EXPRESSION { Ml_definitionrec($3, failwith "let rec type expected", fst $5) , StrSet.remove $3 (snd $5) }
...
application:
 | simple_expr_or_parenthesized_expr simple_expr_or_parenthesized_expr application_next { fst $1 :: fst $2 :: fst $3, StrSet.diff (snd $1) (StrSet.union (snd $2) (snd $3)) }
